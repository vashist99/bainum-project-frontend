      ...
      <div className="container mx-auto p-6 max-w-6xl">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-4">
            <button onClick={() => navigate(-1)} className="btn btn-ghost btn-circle" title="Go back">
          ...
          <div className="card-body">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="stat bg-base-200 rounded-lg">
                ...
                <div className="stat-value text-2xl">{teacher.name}</div>
              </div>
              <div className="stat bg-base-200 rounded-lg">
                ...
                <div className="stat-value text-lg">{teacher.email}</div>
              </div>
              <div className="stat bg-base-200 rounded-lg">
          ...
          <div className="card-body">
            ...
            {transcriptsWithContent.length === 0 ? (
              <div className="alert alert-info">
                ...
                <span>No transcripts yet for this teacher.</span>
              </div>
            ) : (
